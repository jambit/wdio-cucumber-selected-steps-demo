Feature: Test if new windows/tabs are being opened
    ...
    Scenario: Test if we can focus the last opened window/tab
        ...
        Then  the url matches "http://example.com/"
        When  I close the last opened window
